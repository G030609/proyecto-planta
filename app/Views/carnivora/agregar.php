<div class="container">
    <div class="row">
        <div class="col-8">
            <form action="<?= base_url('index.php/carnivora/insert'); ?> " method="POST">
                <?= csrf_field() ?>
                ...
                <div class="form">
                    ...
                    <div class="mb-3">
                        ...
                        placeholder="Ingrese el nombre de la planta" id="nombre_planta" minlength="4" maxlength="150" pattern="[A-Za/s][4-40]">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        placeholder="Ingrese los usos de la planta" id="usos">
                    </div>
                    <div class="mb-3">
